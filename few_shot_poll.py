...
def hlm_forward_prompt(text):
    ...
    prompts += "Input:这些人每个都像这样的恭肃严整，来的人是谁，放诞无礼到这样的地步？\n"
    prompts += "Output:这些人个个恭肃严整如此,这来者系谁,这样放诞无礼?\n"
    prompts += "Input:也还算便宜。\n"
    prompts += "Output:倒也便宜.\n"
    ...
    prompts += "请根据以上成功转化的示例，重写句子，将目标作者风格注入中性输入文本。Output:"
...
def shakespeare_forward_prompt(text):
    ...
    prompts += "Input:What did you say to me?\n"
    prompts += "Output:What say you?\n"
    prompts += "Input:You say he's friendly with Caesar , healthy , and free.\n"
    prompts += "Output:He's friends with Caesar , In state of health , thou say'st , and , thou say'st , free.\n"

    prompts = prompts + "Input:" + text
    prompts += "Please rewrite the sentence to inject target authorship style into the neutral input according to the successful transformation of above demonstrations. Output:"
...
def lyrics_forward_prompt(text):
    ...
    prompts += "Output:Yeah, yeah, you know how me and you do.\n"
    prompts += "Input:I have your arms open.\n"
    prompts += "Output:Your arms are open for me.\n"
    prompts += "Input:It's at least until tomorrow.\n"
    prompts += "Output:So far at least until tomorrow.\n"
    prompts += "Input:Everything I've ever lost.\n"
    prompts += "Output:Everything I ever had to lose.\n"
    prompts += "Input:I'm sure he'll kill him.\n"
    prompts += "Output:And I promise its going to kill.\n"
    prompts += "Input:People are on the street.\n"
    prompts += "Output:And people on the streets.\n"
...
def lyrics_inverse_prompt(text):
    ...
    prompts += "Output:You know our relationship.\n"
    prompts += "Input:Your arms are open for me.\n"
    prompts += "Output:I have your arms open.\n"
    prompts += "Input:So far at least until tomorrow.\n"
    prompts += "Output:It's at least until tomorrow.\n"
    prompts += "Input:Everything I ever had to lose.\n"
    prompts += "Output:Everything I've ever lost.\n"
    prompts += "Input:And I promise its going to kill.\n"
    prompts += "Output:I'm sure he'll kill him.\n"
    prompts += "Input:And people on the streets.\n"
    prompts += "Output:People are on the street.\n"
...
def parallel_forward_prompt(text):
    ...
    prompts += "Input:杏坛再次设立，建立了人民大学，以宏大的目标为出发点。\n"
    prompts += "Output:杏坛再设，建人民大学，出之以宏旨。\n"
    prompts += "Input:肩膀修长，腰部纤细如素线。\n"
    prompts += "Output:肩若削成，腰如约素。\n"
...
def bible_forward_prompt(text):
    ...
    prompts += "Output:or how shall I defy, whom the LORD hath not defied?\n"
    prompts += "Input:How long will you keep your useless thoughts?\n"
    prompts += "Output:How long shall thy vain thoughts lodge within thee?\n"
    prompts += "Input:Laban searched the tents, but didn't find them.\n"
    prompts += "Output:And Laban searched all the tent, but found them not.\n"
    prompts += "Input:Who are you more beautiful than？\n"
    prompts += "Output:Whom dost thou pass in beauty?\n"
    prompts += "Input:They reasoned which of them was the greatest.\n"
    prompts += "Output:Then there arose a reasoning among them, which of them should be greatest.\n"
    prompts += "Input:n addition, the Lord spoke to me, saying:\n"
    prompts += "Output:Moreover the word of the LORD came unto me, saying,\n"
