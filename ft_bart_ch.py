...
def parse_option():
    ...
    parser.add_argument('--model_name_or_path', type = str, default = "fnlp/bart-base-chinese")
    ...
    for epoch in trange(opt.epochs, desc = "Epoch"):
        ...
        for batch in train_dataloder:
            ...
            if train_step_total % num_checkpoint_steps == 0:
                ...
                test_case('为什么明明詹姆斯最后体力不支，但是投那个绝杀球的时候，还能跳那么高？', tokenizer, model)
                test_case('你累了，工作不上心', tokenizer, model)
